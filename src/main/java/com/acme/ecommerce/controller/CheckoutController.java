...
public class CheckoutController {
	...
	String postCouponCode(@ModelAttribute(value="couponCode") @Valid CouponCode couponCode,
          ...
          if(result.hasErrors()) {
            ...
            redirectAttributes.addFlashAttribute("flash",
			    new FlashMessage("Coupon Code between 5 and 10 characters", FlashMessage.Status.FAILURE));
	...
	public void getFile(HttpServletResponse response) {
		...
		try {
	    	...
	    	if (purchase != null) {
	    		...
	    		ctx.setVariable("creditCard", maskCreditCard);
