...
public class CheckoutControllerTest {
	...
	public void postCouponTest() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.post("/checkout/coupon").param("code", "abcdefgh")).andDo(print())
				.andExpect(status().is3xxRedirection())
	...
	public void noCartShippingTest() throws Exception {
        ...
        /**
         * Bug fix: Add form validation to the coupon code field in the first step of the checkout process.
         * A coupon code will be considered valid if it contains between 5 and 10 characters.
         * A unit test should also be added to verify that the added validation is working.
         * @throws Exception
         */
	@Test
	public void bugfix1() throws Exception {

	  mockMvc.perform(MockMvcRequestBuilders.post("/checkout/coupon")
              .param("code", "abcd")).andDo(print())
              .andExpect(flash().attribute("org.springframework.validation.BindingResult.couponCode",
                  hasProperty("fieldErrorCount", equalTo(1))))
              .andExpect(status().is3xxRedirection()).andExpect(redirectedUrl("coupon"));
	}
